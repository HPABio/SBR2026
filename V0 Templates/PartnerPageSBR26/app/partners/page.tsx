...
export default function PartnersPage() {
  const goldSponsors = [
    { name: "BioTech Ventures", logo: "/biotech-ventures-logo.jpg" },
    { name: "GeneFund Capital", logo: "/genefund-capital-logo.jpg" },
    { name: "SynBio Industries", logo: "/synbio-industries-logo.jpg" },
  ]

  const silverSponsors = [
    { name: "BioCircular", logo: "/biocircular-logo.jpg" },
    { name: "GreenChem Solutions", logo: "/greenchem-solutions-logo.jpg" },
    { name: "MetaboliteTech", logo: "/metabolitetech-logo.jpg" },
    { name: "BioScale Partners", logo: "/bioscale-partners-logo.jpg" },
    { name: "Enzyme Dynamics", logo: "/enzyme-dynamics-logo.jpg" },
  ]
